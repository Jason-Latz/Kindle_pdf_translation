...
export const metadata: Metadata = {
  ...
  description: 'Upload a PDF and receive a translated EPUB plus flashcard deck.',
}
          ...
          <footer className="border-t border-slate-800/60 bg-slate-950/80 px-6 py-4 text-sm text-slate-400">
            <div className="mx-auto flex max-w-6xl flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              ...
              <nav className="flex items-center gap-4">
                <a href="https://github.com/Jason-Latz" target="_blank" rel="noreferrer">
                  GitHub
                </a>
                <a href="https://linkedin.com/in/jasonlatz" target="_blank" rel="noreferrer">
                  LinkedIn
                </a>
              </nav>
            </div>
